...
const en = {
  ...
  home: {
    ...
    aboutList: [
      ...
      },
      {
        ...
        desc: "We combine hardware and software: microcontrollers, IoT, electronics and custom firmware.",
      },
    ],
  },
  projects: {
  ...
  contact: {
    ...
    typeOptions: [
      ...
      { value: "plataforma", label: "Web platform / App" },
      { value: "tienda", label: "Online store" },
      { value: "software", label: "Custom software" },
      { value: "automatizacion", label: "Automation" },
      { value: "iot", label: "IoT / Embedded systems" },
      { value: "electronica", label: "Electronics / PCB" },
...
const es: typeof en = {
  ...
  home: {
    ...
    aboutList: [
      ...
      },
      {
        ...
        desc: "Combinamos hardware y software: microcontroladores, IoT, electrónica y firmware a la medida.",
      },
    ],
  },
  projects: {
  ...
  contact: {
    ...
    typeOptions: [
      { value: "web", label: "Página web / Landing" },
      { value: "plataforma", label: "Plataforma web / App" },
      { value: "tienda", label: "Tienda virtual" },
      { value: "software", label: "Software a la medida" },
      { value: "automatizacion", label: "Automatización" },
      { value: "iot", label: "IoT / Sistemas embebidos" },
      { value: "electronica", label: "Electrónica / PCB" },
